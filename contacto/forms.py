...
class ContactForm(forms.Form):
    ...
    widget=forms.TextInput(attrs={'class': 'form-control','placeholder': 'Escribe tu nombre', 'id':'mobile' }),
    ...
    widget=forms.Textarea(attrs={'class': 'form-control', 'rows': 12, 'placeholder': 'Escribe tu mensaje'}),
